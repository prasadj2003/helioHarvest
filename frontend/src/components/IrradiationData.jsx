...
//     // -----------------------------------------------------------------------To process the string data ----------------------------------------------------------
//     function calculateYearlyAverage(dataString) {
//         const lines = dataString.split("\r\n"); // Split string by new line
//         const yearlyData = {};

//         lines.forEach(line => {
//             const parts = line.split("\t").filter(Boolean); // Remove empty elements
//             if (parts.length === 3) {
...
//             // this result is not json format


//             // const filteredData = await axios.post("http://localhost:3000/filterData", JSON.stringify(result.data))
//             // const filteredData = await axios.post("http://localhost:3000/filterData", JSON.stringify(result.data), {
//             //     headers: { "Content-Type": "application/json" }
//             // });
//             console.log(typeof(result.data)) // -> this is a string

//             // const processedData = calculateYearlyAverage(result.data)
//             setProcessedData(calculateYearlyAverage(result.data))
//             setChartData(calculateYearlyAverage(result.data))
...
//         new Chart(
//           document.getElementById('irradiationChart'),
//           {
//             type: 'bar',
//             data: {
...
//     return (
//         <div className="bg-radial-[at_25%_25%] from-white to-zinc-900 to-75% text-white rounded-lg p-6 shadow-lg w-80 flex flex-col items-center">
//             <button
//                 className="bg-black text-xl rounded-lg text-white p-2"
//                 onClick={fetchIrradiationData}
//                 disabled={lat === null || long === null} // Disable button until location is available
//             >
